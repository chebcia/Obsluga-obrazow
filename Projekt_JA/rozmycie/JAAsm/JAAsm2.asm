.data
red_mult1 qword 0.29
green_mult1 qword 0.58
blue_mult1 qword 0.11

red_mult2 qword 0.29
green_mult2 qword 0.58
blue_mult2 qword 0.11

red_mult3 qword 0.29
green_mult3 qword 0.58
blue_mult3 qword 0.11
...
b_w_loop:
        ...
        addsd xmm0, xmm1
        movzx eax, byte ptr[r8 + r10 + 2] ; blue
        cvtsi2sd xmm1, eax
